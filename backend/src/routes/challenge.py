...
async def generate_challenge(challenge_request: ChallengeRequest, request: Request, db: Session = Depends(get_db)):
    try:
...
async def my_history(request: Request, db:Session = Depends(get_db)):
    ...
    challneges = get_user_challenges(db, user_id)
    return {"challenges": challneges}
